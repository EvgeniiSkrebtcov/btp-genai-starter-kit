...
# ------------------------------------------------------------------------------------------------------
# Your global account subdomain (please check in your BTP cockpit whether it's a UUID or a string)
# globalaccount = "yyyyyyyyyyy"
...
target_ai_core_model = ["text-embedding-3-large", "anthropic--claude-3.7-sonnet", "gpt-4o"]
